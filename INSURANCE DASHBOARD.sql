...
union all
select 'Target',
sum(`Cross sell bugdet`) as Amount
from `individual budget`;
...
select `account executive`, count(meeting_date_new) as `Count No Of Meeting`
from meeting
